...
import { useGetVendorProductsQuery } from '../../../services/vendorApi';
import './VendorCollection.css';
...
const VendorCollection = () => {
  ...
  return (
    <div className="vendor-collection-page">
      <div className="container">
        <div className="vendor-collection-header">
          <div>
            <h1 className="vendor-collection-title">My Collection</h1>
            <p className="vendor-collection-subtitle">Manage the garments you offer to your clients.</p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="card" style={{ textAlign: 'center', padding: '4rem 2rem' }}>
            ...
            <Link to="/vendor/products/add" className="btn btn--primary">Start Building Your Collection</Link>
          </div>
        ) : (
          <div className="vendor-collection-grid">
            {products.map(product => (
              <div key={product._id} className="vc-card">
                <Link to={`/vendor/products/detail/${product._id}`} className="vc-card__image-wrap">
                ...
                <div className="vc-card__content">
                  ...
                  <div className="vc-card__actions">
                    <Link to={`/vendor/products/edit/${product._id}`} className="btn btn--outline btn--sm vc-card__btn">
                      Edit details
                    </Link>
                  </div>
                </div>
